...
# def mark_attendance(name):
#     with open('Attendance_Sheet.csv', 'a', newline='') as file:
#         writer = csv.writer(file)
#         writer.writerow([name, datetime.now().strftime('%Y-%m-%d %H:%M:%S')])
...
#     # Resize frame to improve face recognition speed
...
#         # Mark attendance if the face is recognized and not already marked
